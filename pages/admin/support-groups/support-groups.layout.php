...
<main class="admin-main-container">
    ...
    <section class="admin-main-content">
        ...
        <form method="GET" class="admin-sub-container-1" style="justify-content: space-between; align-items: center;">
            <div class="admin-sub-container-1"><button type="button" class="admin-button admin-button--primary">Create Group</button><button type="button" class="admin-button admin-button--ghost">Schedule Session</button></div>
