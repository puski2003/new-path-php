...
class AdminData
{
    ...
    public static function updateUser(int $userId, array $input): array
    {
        ...
        // Keep at least one active admin account in the system.
    ...
    public static function deleteUser(int $userId, int $actorUserId): array
    {
        ...
        // Archive table is not created yet. Keep this SQL ready for when the table exists.
        // Database::iud(
        //     "INSERT INTO archived_users
        //         (user_id, email, username, role, display_name, first_name, last_name, phone_number, is_active, onboarding_completed, created_at, last_login, archived_at, archived_by)
        //      SELECT user_id, email, username, role, display_name, first_name, last_name, phone_number, is_active, onboarding_completed, created_at, last_login, NOW(), $safeActorUserId
        //      FROM users
        //      WHERE user_id = $safeUserId"
        // );
        //
        // Database::iud("DELETE FROM users WHERE user_id = $safeUserId");
